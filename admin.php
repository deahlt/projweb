    ...
    <main>
        <div class="container">
            <form id="animal" action="./includes/animal_process.php" method="post" enctype="multipart/form-data">
                ...
                <fieldset>
                    <input class="name disabled" type="text" name="author_name"
                        value="<?php echo $_SESSION['username']; ?>" readonly>
                </fieldset>

                <fieldset>
                    <input class="name disabled" type="text" name="time_stamp"
                        value="<?php echo $dt->format('d.m.Y'); ?>" readonly>
                </fieldset>

                <fieldset>
                    <input placeholder="Emri" class="emri" type="text" tabindex="1" required autofocus
                        name="animal_name">
                </fieldset>
